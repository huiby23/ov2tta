...
export MODE="${MODE:-ttac_v5_4_delta_push}"
export OUTPUT_TAG="${OUTPUT_TAG:-v5_5_delta_push_weighted_estimator_full_500_seedchunk100_20260623}"
export REPORT_DIR="${REPORT_DIR:-reports/ttac_v5_5_delta_push_full_500_seedchunk100_20260623}"
export LOG_DIR="${LOG_DIR:-logs/ttac_v5_5_delta_push_full_500_seedchunk100_20260623}"
...
bash tools/run_ttac_v5_5_full_eval_sharded.sh
