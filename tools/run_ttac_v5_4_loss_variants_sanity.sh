...
TTAC_V5_4_VALUE_WEIGHT_FLOOR="${TTAC_V5_4_VALUE_WEIGHT_FLOOR:-0.5}"
TTAC_V5_4_VALUE_WEIGHT_SCALE="${TTAC_V5_4_VALUE_WEIGHT_SCALE:-1.5}"
TTAC_V5_4_VALUE_WEIGHT_TEMP="${TTAC_V5_4_VALUE_WEIGHT_TEMP:-5.0}"
...
TTAC_V5_4_REWARD_SCORER_PATH="${TTAC_V5_4_REWARD_SCORER_PATH:-}"
TTAC_V5_4_REWARD_WEIGHT_FLOOR="${TTAC_V5_4_REWARD_WEIGHT_FLOOR:-0.25}"
TTAC_V5_4_REWARD_WEIGHT_SCALE="${TTAC_V5_4_REWARD_WEIGHT_SCALE:-1.5}"
TTAC_V5_4_REWARD_CENTER_AMP="${TTAC_V5_4_REWARD_CENTER_AMP:-2.0}"
TTAC_V5_4_REWARD_CENTER_MIN="${TTAC_V5_4_REWARD_CENTER_MIN:-0.25}"
TTAC_V5_4_REWARD_CENTER_MAX="${TTAC_V5_4_REWARD_CENTER_MAX:-2.0}"
...
REWARD_SCORER_ARGS=()
if [[ -n "${TTAC_V5_4_REWARD_SCORER_PATH}" ]]; then
  REWARD_SCORER_ARGS+=(--ttac_v5_4_reward_scorer_path "${TTAC_V5_4_REWARD_SCORER_PATH}")
fi

{
  ...
  echo "ttac_v5_4_value_weight_floor=${TTAC_V5_4_VALUE_WEIGHT_FLOOR}"
  echo "ttac_v5_4_value_weight_scale=${TTAC_V5_4_VALUE_WEIGHT_SCALE}"
  echo "ttac_v5_4_value_weight_temp=${TTAC_V5_4_VALUE_WEIGHT_TEMP}"
  ...
  echo "ttac_v5_4_reward_scorer_path=${TTAC_V5_4_REWARD_SCORER_PATH}"
  echo "ttac_v5_4_reward_weight_floor=${TTAC_V5_4_REWARD_WEIGHT_FLOOR}"
  echo "ttac_v5_4_reward_weight_scale=${TTAC_V5_4_REWARD_WEIGHT_SCALE}"
  echo "ttac_v5_4_reward_center_amp=${TTAC_V5_4_REWARD_CENTER_AMP}"
  echo "ttac_v5_4_reward_center_min=${TTAC_V5_4_REWARD_CENTER_MIN}"
  echo "ttac_v5_4_reward_center_max=${TTAC_V5_4_REWARD_CENTER_MAX}"
...
run_eval() {
  ...
  "${PYTHON}" experiments/overcooked_v2_experiments/ttac_v5_4_loss_variants/utils/visualize_ppo.py \
    ...
    --ttac_v5_4_value_weight_floor "${TTAC_V5_4_VALUE_WEIGHT_FLOOR}" \
    --ttac_v5_4_value_weight_scale "${TTAC_V5_4_VALUE_WEIGHT_SCALE}" \
    --ttac_v5_4_value_weight_temp "${TTAC_V5_4_VALUE_WEIGHT_TEMP}" \
    ...
    "${REWARD_SCORER_ARGS[@]}" \
    --ttac_v5_4_reward_weight_floor "${TTAC_V5_4_REWARD_WEIGHT_FLOOR}" \
    --ttac_v5_4_reward_weight_scale "${TTAC_V5_4_REWARD_WEIGHT_SCALE}" \
    --ttac_v5_4_reward_center_amp "${TTAC_V5_4_REWARD_CENTER_AMP}" \
    --ttac_v5_4_reward_center_min "${TTAC_V5_4_REWARD_CENTER_MIN}" \
    --ttac_v5_4_reward_center_max "${TTAC_V5_4_REWARD_CENTER_MAX}" \
    > "${LOG_DIR}/eval_${tag}.log" 2>&1
  log "EVAL_DONE mode=${mode}"
}

DEFAULT_MODES="base_no_test_adapt ttac_v5_2_latest ttac_v5_4_delta ttac_v5_4_delta_value_weighted ttac_v5_4_delta_value_tv_weighted ttac_v5_4_delta_reward_weighted ttac_v5_4_delta_reward_centered ttac_v5_4_delta_change_amp ttac_v5_4_delta_move_amp ttac_v5_4_delta_suppress_sticky ttac_v5_4_delta_tv_weighted ttac_v5_4_delta_tv_gate ttac_v5_4_delta_mass_gate ttac_v5_4_delta_tv_mass_gate ttac_v5_4_delta_support ttac_v5_4_low_value_delta ttac_v5_4_anti_stay"
