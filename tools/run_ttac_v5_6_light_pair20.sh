...
REPORT_DIR="${REPORT_DIR:-reports/ttac_v5_6_light_online_pair20_${TS}}"
LOG_DIR="${LOG_DIR:-logs/ttac_v5_6_light_online_pair20_${TS}}"
...
for mode in ${MODES}; do
  ...
  start_s=$(date +%s)
  "${PYTHON}" experiments/overcooked_v2_experiments/ttac_v5_6_light_online/utils/visualize_ppo.py \
    --d "${RUN_DIR}" \
    --seed "${SEED}" \
