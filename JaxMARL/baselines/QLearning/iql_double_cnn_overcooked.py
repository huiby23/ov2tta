    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            def _learn_phase(carry, _):
                ...
                q_next_online = jax.vmap(network.apply, in_axes=(None, 0))(
                    train_state.params, batchify(minibatch.second.obs)
                )  # (num_agents, batch_size, ...)
                next_avail_actions = batchify(minibatch.second.avail_actions)
                q_next_online = q_next_online - (1 - next_avail_actions) * 1e10
