...
from overcooked_v2_experiments.ttac_v5_1_agreement_amp.models.abstract import ActorCriticBase
from overcooked_v2_experiments.ttac_v5_1_agreement_amp.models.model import get_actor_critic, initialize_carry
from overcooked_v2_experiments.ttac_v5_1_agreement_amp.utils.surrogate_heads import (
    apply_q_eta,
    expected_joint_q,
)
from overcooked_v2_experiments.ttac_v5_1_agreement_amp.utils.agreement_heads import (
...
class PPOPolicy(AbstractPolicy):
    ...
    def _ttac_loss(self, params, hstate, use_kl):
        ...
        if agreement_estimator_params is None:
            ...
            latest_pos = self.history_len - 1
            v5_agreement_loss = per_query_ce[latest_pos]
