...
class ActorCriticCNN(ActorCriticBase):
    ...
    def _legacy_call(self, obs, activation, fc_dim):
        ...
        aux = {
            ...
            "adapter_delta": jnp.zeros_like(logits),
            "adapter_delta_norm": jnp.zeros(logits.shape[:-1], dtype=logits.dtype),
        }
    ...
    def __call__(self, hidden, x):
        ...
        if bool(self.config.get("TTAC_LEGACY_CNN", False)):
            return self._legacy_call(obs, activation, fc_dim)
