...
from overcooked_v2_experiments.e3t_state_aug_official.models.model import (
    get_actor_critic,
    initialize_carry,
)
from overcooked_v2_experiments.e3t_state_aug_official.policy import (
    PPOParams,
    PPOPolicy,
    policy_checkoints_to_policy_pairing,
)
from overcooked_v2_experiments.e3t_state_aug_official.utils.store import store_checkpoint
from overcooked_v2_experiments.e3t_state_aug_official.utils.utils import (
...
def state_sample_run(config):
    ...
    with wandb.init(
        ...
        def _init_policy(key):
            ...
            if model_config.get("USE_HISTORY_CONTEXT", True):
