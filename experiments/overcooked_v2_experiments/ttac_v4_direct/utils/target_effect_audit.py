...
from overcooked_v2_experiments.ttac_v4_direct.policy import PPOPolicy
from overcooked_v2_experiments.ttac_v4_direct.utils.store import load_all_checkpoints
from overcooked_v2_experiments.ttac_v4_direct.utils.surrogate_heads import load_surrogate_npz
from overcooked_v2_experiments.ttac_v4_direct.utils.zsc_diagnostics import (
...
AUDIT_MODES = {
    ...
    "v4_direct_q": {
        "eval_mode": "ttac_v4_direct_q",
        "do_update": True,
        "shuffle_actions": False,
        "use_loss": True,
    },
    "v4_direct_q_support": {
        "eval_mode": "ttac_v4_direct_q_support",
        "do_update": True,
        "shuffle_actions": False,
        "use_loss": True,
    },
...
def main():
    ...
    parser.add_argument("--ttac_v4_direct_semantic_coef", type=float, default=0.25)
    parser.add_argument("--ttac_v4_direct_margin_coef", type=float, default=0.1)
    parser.add_argument("--ttac_v4_direct_margin", type=float, default=0.1)
    parser.add_argument("--ttac_v4_direct_recency_tau", type=float, default=10.0)
    parser.add_argument("--ttac_v4_direct_use_change_gate", type=int, default=1)
    parser.add_argument("--ttac_v4_direct_change_gate_floor", type=float, default=0.1)
    parser.add_argument("--ttac_v4_surrogate_path", type=str)
    parser.add_argument("--ttac_v4_direct_q_coef", type=float, default=1.0)
