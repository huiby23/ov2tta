...
from overcooked_v2_experiments.acp.models.abstract import ActorCriticBase
...
def make_train(
    ...
    def train(
        ...
        def _update_step(runner_state, unused):
                    ...
                    def _loss_fn(params, init_hstate, traj_batch, gae, targets):
                        ...
                        _, pi, value, aux = _apply_training_network(
                            ...
                            (
                                traj_batch.obs,
                                traj_batch.done,
                                traj_batch.partner_action.astype(jnp.int32),
                                jnp.ones_like(
                                    traj_batch.partner_action, dtype=jnp.bool_
                                ),
                            ),
                        )
            ...
            value_loss, loss_actor, entropy, ratio, partner_loss, partner_acc = aux_data
