...
from overcooked_v2_experiments.ttac_v5_6_light_online.policy import PPOPolicy
from overcooked_v2_experiments.ttac_v5_6_light_online.utils.store import load_all_checkpoints
from overcooked_v2_experiments.ttac_v5_6_light_online.utils.surrogate_heads import load_surrogate_npz
from overcooked_v2_experiments.ttac_v5_6_light_online.utils.agreement_heads import load_agreement_npz
from overcooked_v2_experiments.ttac_v5_6_light_online.utils.zsc_diagnostics import (
...
AUDIT_MODES = {
    ...
    "v4_direct_q": {
        "eval_mode": "ttac_v5_6_light_online_q",
        "do_update": True,
        "shuffle_actions": False,
        "use_loss": True,
    },
    "v4_direct_q_support": {
        "eval_mode": "ttac_v5_6_light_online_q_support",
        "do_update": True,
        "shuffle_actions": False,
        "use_loss": True,
    },
...
def apply_model_overrides(config, args):
    ...
    overrides = {
        ...
        "TTAC_V3_SEMANTIC_COEF": args.ttac_v5_6_light_online_semantic_coef,
        "TTAC_V3_MARGIN_COEF": args.ttac_v5_6_light_online_margin_coef,
        "TTAC_V3_MARGIN": args.ttac_v5_6_light_online_margin,
        "TTAC_V3_RECENCY_TAU": args.ttac_v5_6_light_online_recency_tau,
        "TTAC_V3_USE_CHANGE_GATE": None if args.ttac_v5_6_light_online_use_change_gate is None else bool(args.ttac_v5_6_light_online_use_change_gate),
        "TTAC_V3_CHANGE_GATE_FLOOR": args.ttac_v5_6_light_online_change_gate_floor,
        "TTAC_V4_SURROGATE": surrogate_params,
        "TTAC_V4_DIRECT_Q_COEF": args.ttac_v5_6_light_online_q_coef,
...
def main():
    ...
    parser.add_argument("--ttac_v5_6_light_online_semantic_coef", type=float, default=0.25)
    parser.add_argument("--ttac_v5_6_light_online_margin_coef", type=float, default=0.1)
    parser.add_argument("--ttac_v5_6_light_online_margin", type=float, default=0.1)
    parser.add_argument("--ttac_v5_6_light_online_recency_tau", type=float, default=10.0)
    parser.add_argument("--ttac_v5_6_light_online_use_change_gate", type=int, default=1)
    parser.add_argument("--ttac_v5_6_light_online_change_gate_floor", type=float, default=0.1)
    parser.add_argument("--ttac_v4_surrogate_path", type=str)
    parser.add_argument("--ttac_v5_6_light_online_q_coef", type=float, default=1.0)
