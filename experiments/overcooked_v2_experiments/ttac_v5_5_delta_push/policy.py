...
from overcooked_v2_experiments.ttac_v5_5_delta_push.models.abstract import ActorCriticBase
from overcooked_v2_experiments.ttac_v5_5_delta_push.models.model import get_actor_critic, initialize_carry
from overcooked_v2_experiments.ttac_v5_5_delta_push.utils.surrogate_heads import (
    apply_q_eta,
    expected_joint_q,
)
...
EVAL_MODES = (
    ...
    "ttac_v5_4_delta",
    "ttac_v5_4_delta_wrong_history",
    "ttac_v5_4_delta_random_history",
    "ttac_v5_4_delta_delayed_history",
    ...
    "ttac_v5_4_delta_tv_gate",
    "ttac_v5_4_delta_tv_gate_wrong_history",
    "ttac_v5_4_delta_tv_gate_random_history",
    "ttac_v5_4_delta_tv_gate_delayed_history",
    "ttac_v5_4_delta_mass_gate",
    "ttac_v5_4_delta_mass_gate_wrong_history",
    "ttac_v5_4_delta_mass_gate_random_history",
    "ttac_v5_4_delta_mass_gate_delayed_history",
    "ttac_v5_4_delta_tv_mass_gate",
    "ttac_v5_4_delta_tv_mass_gate_wrong_history",
    "ttac_v5_4_delta_tv_mass_gate_random_history",
    "ttac_v5_4_delta_tv_mass_gate_delayed_history",
    "ttac_v5_4_delta_tv_weighted",
    "ttac_v5_4_delta_tv_weighted_wrong_history",
    "ttac_v5_4_delta_tv_weighted_random_history",
    "ttac_v5_4_delta_tv_weighted_delayed_history",
    "ttac_v5_4_delta_value_weighted",
    "ttac_v5_4_delta_value_weighted_wrong_history",
    "ttac_v5_4_delta_value_weighted_random_history",
    "ttac_v5_4_delta_value_weighted_delayed_history",
    "ttac_v5_4_delta_value_tv_weighted",
    "ttac_v5_4_delta_value_tv_weighted_wrong_history",
    "ttac_v5_4_delta_value_tv_weighted_random_history",
    "ttac_v5_4_delta_value_tv_weighted_delayed_history",
    "ttac_v5_4_delta_change_amp",
    "ttac_v5_4_delta_change_amp_wrong_history",
    "ttac_v5_4_delta_change_amp_random_history",
    "ttac_v5_4_delta_change_amp_delayed_history",
    "ttac_v5_4_delta_move_amp",
    "ttac_v5_4_delta_move_amp_wrong_history",
    "ttac_v5_4_delta_move_amp_random_history",
    "ttac_v5_4_delta_move_amp_delayed_history",
    "ttac_v5_4_delta_suppress_sticky",
    "ttac_v5_4_delta_suppress_sticky_wrong_history",
    "ttac_v5_4_delta_suppress_sticky_random_history",
    "ttac_v5_4_delta_suppress_sticky_delayed_history",
    "ttac_v5_4_delta_support",
    "ttac_v5_4_delta_support_wrong_history",
    "ttac_v5_4_delta_support_random_history",
    "ttac_v5_4_delta_support_delayed_history",
    "ttac_v5_4_delta_reward_weighted",
    "ttac_v5_4_delta_reward_weighted_wrong_history",
    "ttac_v5_4_delta_reward_weighted_random_history",
    "ttac_v5_4_delta_reward_weighted_delayed_history",
    "ttac_v5_4_delta_reward_centered",
    "ttac_v5_4_delta_reward_centered_wrong_history",
    "ttac_v5_4_delta_reward_centered_random_history",
    "ttac_v5_4_delta_reward_centered_delayed_history",
    "ttac_v5_4_low_value_delta",
    "ttac_v5_4_low_value_delta_wrong_history",
    "ttac_v5_4_low_value_delta_random_history",
    "ttac_v5_4_low_value_delta_delayed_history",
    "ttac_v5_4_anti_stay",
    "ttac_v5_4_anti_stay_wrong_history",
    "ttac_v5_4_anti_stay_random_history",
    "ttac_v5_4_anti_stay_delayed_history",
    "ttac_wrong_history",
    "ttac_random_history",
...
class PPOPolicy(AbstractPolicy):
    ...
    def _ttac_loss(self, params, hstate, use_kl):
        ...
        if agreement_estimator_params is None:
            ...
            v5_4_delta_loss = jnp.array(0.0, dtype=jnp.float32)
            v5_4_delta_push_loss = jnp.array(0.0, dtype=jnp.float32)
            v5_5_top_delta_loss = jnp.array(0.0, dtype=jnp.float32)
            v5_4_low_value_delta_loss = jnp.array(0.0, dtype=jnp.float32)
            v5_4_anti_stay_loss = jnp.array(0.0, dtype=jnp.float32)
            v5_4_latest_delta_mass = jnp.array(0.0, dtype=jnp.float32)
            v5_4_latest_base_stay_prob = jnp.array(0.0, dtype=jnp.float32)
            v5_4_delta_mass_gate = jnp.array(0.0, dtype=jnp.float32)
            v5_4_delta_tv_mass_gate = jnp.array(0.0, dtype=jnp.float32)
            v5_4_delta_tv_weight = jnp.array(1.0, dtype=jnp.float32)
            v5_4_delta_value_weight = jnp.array(1.0, dtype=jnp.float32)
            v5_4_delta_value_tv_weight = jnp.array(1.0, dtype=jnp.float32)
            v5_4_delta_change_weight = jnp.array(1.0, dtype=jnp.float32)
            v5_4_delta_move_weight = jnp.array(1.0, dtype=jnp.float32)
            v5_4_delta_sticky_weight = jnp.array(1.0, dtype=jnp.float32)
            v5_4_delta_reward_weight = jnp.array(1.0, dtype=jnp.float32)
            v5_4_delta_reward_center_weight = jnp.array(1.0, dtype=jnp.float32)
            v5_4_delta_reward_score = jnp.array(0.0, dtype=jnp.float32)
        else:
            latest_idx = (hstate.cursor - 1) % self.history_len
            order = (hstate.cursor - self.history_len + jnp.arange(self.history_len)) % self.history_len
            chron_actions = hstate.partner_action_buffer[order]
            ...
            # v5.4: do not blindly match the full estimator distribution.
            # Instead, convert the estimator into a residual target relative to
            # the frozen base policy. This only pushes actions that the
            # estimated partner convention prefers more than the base already
            # does, preserving base competence while allowing local correction.
            v5_4_delta_margin = jnp.asarray(
                self.model_config.get("TTAC_V5_4_DELTA_MARGIN", 0.0), dtype=jnp.float32
            )
            v5_4_delta_scale = jnp.asarray(
                self.model_config.get("TTAC_V5_4_DELTA_SCALE", 2.0), dtype=jnp.float32
            )
            per_query_positive_delta = jnp.maximum(
                estimator_probs - query_base_probs - v5_4_delta_margin,
                0.0,
            )
            per_query_delta_mass = jnp.sum(per_query_positive_delta, axis=-1)
            per_query_delta_target = query_base_probs + v5_4_delta_scale * per_query_positive_delta
            per_query_delta_target = per_query_delta_target / jnp.maximum(
                jnp.sum(per_query_delta_target, axis=-1, keepdims=True), 1e-6
            )
            per_query_delta_ce = -jnp.sum(
                jax.lax.stop_gradient(per_query_delta_target) * query_ego_log_probs,
                axis=-1,
            )
            # Residual push loss: only reinforce actions that the estimator
            # assigns more probability to than the frozen base. Unlike the CE
            # target above, this does not ask the adapter to fit a full target
            # distribution; the gradient magnitude is naturally scaled by the
            # amount of positive residual mass.
            per_query_delta_push = -jnp.sum(
                jax.lax.stop_gradient(per_query_positive_delta) * query_ego_log_probs,
                axis=-1,
            )
            # v5.5 top-delta: an even sharper local correction probe. It tests
            # whether the reward gain comes from switching a small number of
            # high-leverage actions rather than fitting a whole residual
            # distribution. The mass term keeps weak/noisy residuals small.
            per_query_top_delta_idx = jnp.argmax(per_query_positive_delta, axis=-1)
            per_query_top_delta_mask = jax.nn.one_hot(
                per_query_top_delta_idx, self.action_dim
            )
            per_query_top_delta_valid = (per_query_delta_mass > 1e-6).astype(jnp.float32)
            per_query_top_delta = (
                -jnp.sum(
                    jax.lax.stop_gradient(per_query_top_delta_mask) * query_ego_log_probs,
                    axis=-1,
                )
                * jax.lax.stop_gradient(per_query_delta_mass)
                * per_query_top_delta_valid
            )
            v5_4_delta_loss = jnp.take(per_query_delta_ce, v5_2_query_pos, axis=0)
            v5_4_delta_push_loss = jnp.take(
                per_query_delta_push, v5_2_query_pos, axis=0
            )
            v5_5_top_delta_loss = jnp.take(per_query_top_delta, v5_2_query_pos, axis=0)
            v5_4_low_value_delta_loss = v5_2_value_tv_gate * v5_4_delta_loss
            v5_4_latest_delta_mass = jnp.take(per_query_delta_mass, v5_2_query_pos, axis=0)
            v5_4_delta_mass_threshold = jnp.asarray(
                self.model_config.get("TTAC_V5_4_DELTA_MASS_THRESHOLD", 0.03),
                dtype=jnp.float32,
            )
            v5_4_delta_mass_gate = latest_valid * (
                v5_4_latest_delta_mass >= v5_4_delta_mass_threshold
            ).astype(jnp.float32)
            v5_4_delta_tv_mass_gate = v5_2_tv_gate * v5_4_delta_mass_gate
            v5_4_tv_weight_floor = jnp.asarray(
                self.model_config.get("TTAC_V5_4_TV_WEIGHT_FLOOR", 0.25),
                dtype=jnp.float32,
            )
            v5_4_tv_weight_scale = jnp.asarray(
                self.model_config.get("TTAC_V5_4_TV_WEIGHT_SCALE", 4.0),
                dtype=jnp.float32,
            )
            v5_4_delta_tv_weight = latest_valid * jnp.maximum(
                v5_4_tv_weight_floor,
                jnp.minimum(1.0, v5_4_tv_weight_scale * v5_2_latest_target_base_tv),
            )
            v5_4_value_weight_floor = jnp.asarray(
                self.model_config.get("TTAC_V5_4_VALUE_WEIGHT_FLOOR", 0.5),
                dtype=jnp.float32,
            )
            v5_4_value_weight_scale = jnp.asarray(
                self.model_config.get("TTAC_V5_4_VALUE_WEIGHT_SCALE", 1.5),
                dtype=jnp.float32,
            )
            v5_4_value_weight_temp = jnp.asarray(
                self.model_config.get("TTAC_V5_4_VALUE_WEIGHT_TEMP", 5.0),
                dtype=jnp.float32,
            )
            v5_4_low_value_score = jax.nn.sigmoid(
                (value_center_v5 - v5_2_latest_value)
                / jnp.maximum(v5_4_value_weight_temp, 1e-6)
            )
            v5_4_tv_score = jnp.minimum(
                1.0, v5_4_tv_weight_scale * v5_2_latest_target_base_tv
            )
            v5_4_delta_value_weight = latest_valid * (
                v5_4_value_weight_floor + v5_4_value_weight_scale * v5_4_low_value_score
            )
            v5_4_delta_value_tv_weight = latest_valid * (
                v5_4_value_weight_floor
                + v5_4_value_weight_scale * v5_4_low_value_score * v5_4_tv_score
            )
            latest_base_argmax = jnp.argmax(
                jnp.take(query_base_probs, v5_2_query_pos, axis=0), axis=-1
            )
            latest_estimator_argmax = jnp.argmax(
                jnp.take(estimator_probs, v5_2_query_pos, axis=0), axis=-1
            )
            latest_delta_argmax = jnp.argmax(
                jnp.take(per_query_delta_target, v5_2_query_pos, axis=0), axis=-1
            )
            latest_delta_changes_base = (latest_delta_argmax != latest_base_argmax).astype(jnp.float32)
            latest_estimator_changes_base = (
                latest_estimator_argmax != latest_base_argmax
            ).astype(jnp.float32)
            latest_delta_is_move = (latest_delta_argmax <= 3).astype(jnp.float32)
            latest_base_is_move = (latest_base_argmax <= 3).astype(jnp.float32)
            latest_estimator_is_move = (latest_estimator_argmax <= 3).astype(jnp.float32)
            v5_4_change_amp = jnp.asarray(
                self.model_config.get("TTAC_V5_4_CHANGE_AMP", 1.0), dtype=jnp.float32
            )
            v5_4_delta_change_weight = latest_valid * (
                1.0 + v5_4_change_amp * latest_delta_changes_base
            )
            v5_4_delta_move_weight = latest_valid * (
                1.0 + v5_4_change_amp * latest_delta_changes_base * latest_delta_is_move
            )
            v5_4_sticky_action = jnp.asarray(
                self.model_config.get("TTAC_V5_4_STICKY_ACTION", 5), dtype=jnp.int32
            )
            v5_4_sticky_suppress = jnp.asarray(
                self.model_config.get("TTAC_V5_4_STICKY_SUPPRESS", 0.5), dtype=jnp.float32
            )
            sticky_same = (
                (latest_base_argmax == v5_4_sticky_action)
                & (latest_delta_argmax == v5_4_sticky_action)
            ).astype(jnp.float32)
            v5_4_delta_sticky_weight = latest_valid * (
                1.0 - v5_4_sticky_suppress * sticky_same
            )
            latest_delta_target = jnp.take(per_query_delta_target, v5_2_query_pos, axis=0)
            latest_base_probs = jnp.take(query_base_probs, v5_2_query_pos, axis=0)
            v5_4_latest_delta_base_tv = 0.5 * jnp.sum(
                jnp.abs(latest_delta_target - latest_base_probs), axis=-1
            )
            latest_delta_is_interact = (
                latest_delta_argmax == v5_4_sticky_action
            ).astype(jnp.float32)
            latest_base_is_interact = (
                latest_base_argmax == v5_4_sticky_action
            ).astype(jnp.float32)
            v5_4_stay_action_for_scorer = jnp.asarray(
                self.model_config.get("TTAC_V5_4_STAY_ACTION", 4), dtype=jnp.int32
            )
            latest_base_is_stay = (
                latest_base_argmax == v5_4_stay_action_for_scorer
            ).astype(jnp.float32)
            latest_base_argmax_oh = jax.nn.one_hot(latest_base_argmax, self.action_dim)
            latest_estimator_argmax_oh = jax.nn.one_hot(
                latest_estimator_argmax, self.action_dim
            )
            latest_delta_argmax_oh = jax.nn.one_hot(latest_delta_argmax, self.action_dim)
            reward_scorer_features = jnp.concatenate(
                [
                    jnp.asarray(
                        [
                            v5_2_latest_target_base_tv,
                            v5_4_latest_delta_base_tv,
                            v5_4_latest_delta_mass,
                            v5_2_latest_value,
                            latest_delta_changes_base,
                            latest_estimator_changes_base,
                            latest_delta_is_move,
                            latest_base_is_move,
                            latest_estimator_is_move,
                            latest_delta_is_interact,
                            latest_base_is_interact,
                            sticky_same,
                            latest_base_is_stay,
                    ...
                    latest_base_argmax_oh.astype(jnp.float32),
                    latest_estimator_argmax_oh.astype(jnp.float32),
                    latest_delta_argmax_oh.astype(jnp.float32),
                ],
                axis=0,
            )
            reward_scorer = self.model_config.get("TTAC_V5_4_REWARD_SCORER", None)
            if reward_scorer is None:
                v5_4_delta_reward_score = jnp.array(0.5, dtype=jnp.float32)
            else:
                reward_feature_mean = jnp.asarray(
                    reward_scorer["feature_mean"], dtype=jnp.float32
                )
                reward_feature_std = jnp.asarray(
                    reward_scorer["feature_std"], dtype=jnp.float32
                )
                reward_coef = jnp.asarray(reward_scorer["coef"], dtype=jnp.float32)
                reward_bias = jnp.asarray(reward_scorer["bias"], dtype=jnp.float32)
                reward_z = (reward_scorer_features - reward_feature_mean) / jnp.maximum(
                    reward_feature_std, 1e-6
                )
                v5_4_delta_reward_score = jax.nn.sigmoid(
                    jnp.sum(reward_z * reward_coef) + reward_bias
                )
            reward_weight_floor = jnp.asarray(
                self.model_config.get("TTAC_V5_4_REWARD_WEIGHT_FLOOR", 0.25),
                dtype=jnp.float32,
            )
            reward_weight_scale = jnp.asarray(
                self.model_config.get("TTAC_V5_4_REWARD_WEIGHT_SCALE", 1.5),
                dtype=jnp.float32,
            )
            v5_4_delta_reward_weight = latest_valid * (
                reward_weight_floor + reward_weight_scale * v5_4_delta_reward_score
            )
            scorer_score_mean = jnp.asarray(0.5, dtype=jnp.float32)
            if reward_scorer is not None and "score_mean" in reward_scorer:
                scorer_score_mean = jnp.asarray(
                    reward_scorer["score_mean"], dtype=jnp.float32
                )
            reward_center_amp = jnp.asarray(
                self.model_config.get("TTAC_V5_4_REWARD_CENTER_AMP", 2.0),
                dtype=jnp.float32,
            )
            reward_center_min = jnp.asarray(
                self.model_config.get("TTAC_V5_4_REWARD_CENTER_MIN", 0.25),
                dtype=jnp.float32,
            )
            reward_center_max = jnp.asarray(
                self.model_config.get("TTAC_V5_4_REWARD_CENTER_MAX", 2.0),
                dtype=jnp.float32,
            )
            v5_4_delta_reward_center_weight = latest_valid * jnp.clip(
                1.0
                + reward_center_amp
                * (v5_4_delta_reward_score - scorer_score_mean),
                reward_center_min,
                reward_center_max,
            )

            # v5.4 anti-stay: a deliberately simple support-refinement probe.
            # The old attribution suggested part of the gain may come from
            # escaping low-value/stuck local states. Since action 4 is used as
            # the initial STAY/no-op action throughout this codebase, this loss
            # softly shifts probability mass away from STAY only when the
            # latest query is both high-TV and low-value.
            v5_4_stay_action = int(self.model_config.get("TTAC_V5_4_STAY_ACTION", 4))
            stay_onehot = jax.nn.one_hot(
                jnp.asarray(v5_4_stay_action, dtype=jnp.int32), self.action_dim
            )
            nonstay_base = query_base_probs * (1.0 - stay_onehot[None, :])
            uniform_nonstay = (1.0 - stay_onehot[None, :]) / jnp.maximum(
                jnp.asarray(self.action_dim - 1, dtype=jnp.float32), 1.0
            )
            nonstay_base = jnp.where(
                jnp.sum(nonstay_base, axis=-1, keepdims=True) > 1e-6,
                nonstay_base / jnp.maximum(jnp.sum(nonstay_base, axis=-1, keepdims=True), 1e-6),
                uniform_nonstay,
            )
            anti_stay_coef = jnp.asarray(
                self.model_config.get("TTAC_V5_4_ANTI_STAY_COEF", 0.5), dtype=jnp.float32
            )
            anti_stay_target = (1.0 - anti_stay_coef) * query_base_probs + anti_stay_coef * nonstay_base
            anti_stay_target = anti_stay_target / jnp.maximum(
                jnp.sum(anti_stay_target, axis=-1, keepdims=True), 1e-6
            )
            per_query_anti_stay_ce = -jnp.sum(
                jax.lax.stop_gradient(anti_stay_target) * query_ego_log_probs,
                axis=-1,
            )
            v5_4_latest_base_stay_prob = jnp.sum(
                jnp.take(query_base_probs, v5_2_query_pos, axis=0) * stay_onehot,
                axis=-1,
            )
            v5_4_anti_stay_loss = v5_2_value_tv_gate * jnp.take(
                per_query_anti_stay_ce, v5_2_query_pos, axis=0
            )
        ...
        if self.eval_mode == "ttac_projected_history":
            ...
            agreement_loss = v5_agreement_coef * v5_4_delta_loss
        elif self.eval_mode in (
            "ttac_v5_4_delta_push",
            "ttac_v5_4_delta_push_wrong_history",
            "ttac_v5_4_delta_push_random_history",
            ...
            agreement_loss = v5_agreement_coef * v5_4_delta_push_loss
        elif self.eval_mode in (
            "ttac_v5_5_top_delta",
            "ttac_v5_5_top_delta_wrong_history",
            "ttac_v5_5_top_delta_random_history",
            ...
            agreement_loss = v5_agreement_coef * v5_5_top_delta_loss
        elif self.eval_mode in (
            "ttac_v5_4_delta_tv_gate",
            "ttac_v5_4_delta_tv_gate_wrong_history",
            "ttac_v5_4_delta_tv_gate_random_history",
            ...
            agreement_loss = v5_agreement_coef * v5_4_delta_loss
            mode_loss_gate = v5_4_delta_mass_gate
        elif self.eval_mode in (
            "ttac_v5_4_delta_tv_mass_gate",
            "ttac_v5_4_delta_tv_mass_gate_wrong_history",
            "ttac_v5_4_delta_tv_mass_gate_random_history",
            ...
            agreement_loss = v5_agreement_coef * v5_4_delta_loss
            mode_loss_gate = v5_4_delta_tv_mass_gate
        elif self.eval_mode in (
            "ttac_v5_4_delta_tv_weighted",
            "ttac_v5_4_delta_tv_weighted_wrong_history",
            "ttac_v5_4_delta_tv_weighted_random_history",
            ...
            agreement_loss = v5_agreement_coef * v5_4_delta_loss
            mode_loss_gate = v5_4_delta_tv_weight
        elif self.eval_mode in (
            "ttac_v5_4_delta_value_weighted",
            "ttac_v5_4_delta_value_weighted_wrong_history",
            "ttac_v5_4_delta_value_weighted_random_history",
            ...
            agreement_loss = v5_agreement_coef * v5_4_delta_value_weight * v5_4_delta_loss
        elif self.eval_mode in (
            "ttac_v5_4_delta_value_tv_weighted",
            "ttac_v5_4_delta_value_tv_weighted_wrong_history",
            "ttac_v5_4_delta_value_tv_weighted_random_history",
            ...
            agreement_loss = v5_agreement_coef * v5_4_delta_value_tv_weight * v5_4_delta_loss
        elif self.eval_mode in (
            "ttac_v5_4_delta_change_amp",
            "ttac_v5_4_delta_change_amp_wrong_history",
            "ttac_v5_4_delta_change_amp_random_history",
            ...
            agreement_loss = v5_agreement_coef * v5_4_delta_change_weight * v5_4_delta_loss
        elif self.eval_mode in (
            "ttac_v5_4_delta_move_amp",
            "ttac_v5_4_delta_move_amp_wrong_history",
            "ttac_v5_4_delta_move_amp_random_history",
            ...
            agreement_loss = v5_agreement_coef * v5_4_delta_move_weight * v5_4_delta_loss
        elif self.eval_mode in (
            "ttac_v5_4_delta_suppress_sticky",
            "ttac_v5_4_delta_suppress_sticky_wrong_history",
            "ttac_v5_4_delta_suppress_sticky_random_history",
            ...
            agreement_loss = v5_agreement_coef * v5_4_delta_sticky_weight * v5_4_delta_loss
        elif self.eval_mode in (
            "ttac_v5_4_delta_support",
            "ttac_v5_4_delta_support_wrong_history",
            "ttac_v5_4_delta_support_random_history",
            ...
            agreement_loss = (
                v5_agreement_coef * v5_4_delta_loss
                + v5_support_coef * v3_support_aw_loss
            )
        elif self.eval_mode in (
            "ttac_v5_4_delta_reward_weighted",
            "ttac_v5_4_delta_reward_weighted_wrong_history",
            ...
            agreement_loss = (
                v5_agreement_coef * v5_4_delta_reward_weight * v5_4_delta_loss
            )
        elif self.eval_mode in (
            "ttac_v5_4_delta_reward_centered",
            "ttac_v5_4_delta_reward_centered_wrong_history",
            ...
            agreement_loss = (
                v5_agreement_coef * v5_4_delta_reward_center_weight * v5_4_delta_loss
            )
        elif self.eval_mode in (
            "ttac_v5_4_low_value_delta",
            "ttac_v5_4_low_value_delta_wrong_history",
            ...
            agreement_loss = v5_agreement_coef * v5_4_low_value_delta_loss
        elif self.eval_mode in (
            "ttac_v5_4_anti_stay",
            "ttac_v5_4_anti_stay_wrong_history",
            "ttac_v5_4_anti_stay_random_history",
            ...
            agreement_loss = v5_agreement_coef * v5_4_anti_stay_loss
        ...
        aux = {
            ...
            "v5_4_delta_loss": v5_4_delta_loss,
            "v5_4_delta_push_loss": v5_4_delta_push_loss,
            "v5_4_low_value_delta_loss": v5_4_low_value_delta_loss,
            "v5_4_anti_stay_loss": v5_4_anti_stay_loss,
            "v5_4_latest_delta_mass": v5_4_latest_delta_mass,
            "v5_4_latest_base_stay_prob": v5_4_latest_base_stay_prob,
            "v5_4_delta_mass_gate": v5_4_delta_mass_gate,
            "v5_4_delta_tv_mass_gate": v5_4_delta_tv_mass_gate,
            "v5_4_delta_tv_weight": v5_4_delta_tv_weight,
            "v5_4_delta_value_weight": v5_4_delta_value_weight,
            "v5_4_delta_value_tv_weight": v5_4_delta_value_tv_weight,
            "v5_4_delta_change_weight": v5_4_delta_change_weight,
            "v5_4_delta_move_weight": v5_4_delta_move_weight,
            "v5_4_delta_sticky_weight": v5_4_delta_sticky_weight,
            "v5_4_delta_reward_score": v5_4_delta_reward_score,
            "v5_4_delta_reward_weight": v5_4_delta_reward_weight,
            "v5_4_delta_reward_center_weight": v5_4_delta_reward_center_weight,
        }
        return loss, aux
