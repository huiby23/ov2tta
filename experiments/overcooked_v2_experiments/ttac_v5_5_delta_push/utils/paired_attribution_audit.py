...
def compute_estimator_logits(estimator, query_obs, partner_obs, hist, action_dim, batch_size=512):
    logits = []
...
def main():
    ...
    parser.add_argument("--estimator_batch_size", type=int, default=512)
