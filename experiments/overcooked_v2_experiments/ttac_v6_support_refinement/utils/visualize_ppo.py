...
from overcooked_v2_experiments.ttac_v6_support_refinement.utils.store import (
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ttac_v6_tv_threshold", type=float)
    parser.add_argument("--ttac_v6_value_margin", type=float)
    parser.add_argument("--ttac_v6_conf_threshold", type=float)
    parser.add_argument("--ttac_v6_tv_slope", type=float)
    parser.add_argument("--ttac_v6_value_slope", type=float)
    parser.add_argument("--ttac_v6_conf_slope", type=float)
    parser.add_argument("--ttac_v6_beta_scale", type=float)
    parser.add_argument("--ttac_v6_beta_max", type=float)
    parser.add_argument("--ttac_v6_amp_scale", type=float)
    parser.add_argument("--ttac_v6_amp_max", type=float)
    ...
    model_overrides = {
        ...
        "TTAC_V6_TV_THRESHOLD": args.ttac_v6_tv_threshold,
        "TTAC_V6_VALUE_MARGIN": args.ttac_v6_value_margin,
        "TTAC_V6_CONF_THRESHOLD": args.ttac_v6_conf_threshold,
        "TTAC_V6_TV_SLOPE": args.ttac_v6_tv_slope,
        "TTAC_V6_VALUE_SLOPE": args.ttac_v6_value_slope,
        "TTAC_V6_CONF_SLOPE": args.ttac_v6_conf_slope,
        "TTAC_V6_BETA_SCALE": args.ttac_v6_beta_scale,
        "TTAC_V6_BETA_MAX": args.ttac_v6_beta_max,
        "TTAC_V6_AMP_SCALE": args.ttac_v6_amp_scale,
        "TTAC_V6_AMP_MAX": args.ttac_v6_amp_max,
    }
