...
from overcooked_v2_experiments.ttac_v3.models.abstract import ActorCriticBase
from overcooked_v2_experiments.ttac_v3.models.model import get_actor_critic, initialize_carry
...
EVAL_MODES = (
    ...
    "ttac_v3_support_aw",
    "ttac_v3_support_aw_wrong_history",
    "ttac_v3_support_aw_random_history",
    "ttac_v3_support_aw_delayed_history",
    "ttac_v3_gated_semantic",
    "ttac_v3_gated_semantic_wrong_history",
    "ttac_v3_gated_semantic_random_history",
    "ttac_v3_gated_semantic_delayed_history",
    "ttac_v3_gated_margin",
    "ttac_v3_gated_margin_wrong_history",
    "ttac_v3_gated_margin_random_history",
    "ttac_v3_gated_margin_delayed_history",
    "ttac_v3_margin_only",
    "ttac_v3_margin_only_wrong_history",
    "ttac_v3_margin_only_random_history",
    "ttac_v3_margin_only_delayed_history",
    "ttac_wrong_history",
    "ttac_random_history",
