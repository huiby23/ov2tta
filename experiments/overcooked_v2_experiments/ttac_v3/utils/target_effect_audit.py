...
from overcooked_v2_experiments.ttac_v3.policy import PPOPolicy
from overcooked_v2_experiments.ttac_v3.utils.store import load_all_checkpoints
...
AUDIT_MODES = {
    ...
    "v3_support_aw": {
        "eval_mode": "ttac_v3_support_aw",
        "do_update": True,
        "shuffle_actions": False,
        "use_loss": True,
    },
    "v3_gated_semantic": {
        "eval_mode": "ttac_v3_gated_semantic",
        "do_update": True,
        "shuffle_actions": False,
        "use_loss": True,
    },
    "v3_gated_margin": {
        "eval_mode": "ttac_v3_gated_margin",
        "do_update": True,
        "shuffle_actions": False,
        "use_loss": True,
    },
    "v3_margin_only": {
        "eval_mode": "ttac_v3_margin_only",
        "do_update": True,
        "shuffle_actions": False,
        "use_loss": True,
    },
...
def apply_model_overrides(config, args):
    overrides = {
        ...
        "TTAC_V3_SEMANTIC_COEF": args.ttac_v3_semantic_coef,
        "TTAC_V3_MARGIN_COEF": args.ttac_v3_margin_coef,
        "TTAC_V3_MARGIN": args.ttac_v3_margin,
        "TTAC_V3_RECENCY_TAU": args.ttac_v3_recency_tau,
        "TTAC_V3_USE_CHANGE_GATE": None if args.ttac_v3_use_change_gate is None else bool(args.ttac_v3_use_change_gate),
        "TTAC_V3_CHANGE_GATE_FLOOR": args.ttac_v3_change_gate_floor,
    }
...
def main():
    ...
    parser.add_argument("--ttac_v3_semantic_coef", type=float, default=0.25)
    parser.add_argument("--ttac_v3_margin_coef", type=float, default=0.1)
    parser.add_argument("--ttac_v3_margin", type=float, default=0.1)
    parser.add_argument("--ttac_v3_recency_tau", type=float, default=10.0)
    parser.add_argument("--ttac_v3_use_change_gate", type=int, default=1)
    parser.add_argument("--ttac_v3_change_gate_floor", type=float, default=0.1)
