...
from overcooked_v2_experiments.ttac_v7_return_correction.utils.store import (
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ttac_v7_tv_threshold", type=float)
    parser.add_argument("--ttac_v7_tv_slope", type=float)
    parser.add_argument("--ttac_v7_value_margin", type=float)
    parser.add_argument("--ttac_v7_value_temp", type=float)
    parser.add_argument("--ttac_v7_correction_coef", type=float)
    parser.add_argument("--ttac_v7_support_coef", type=float)
    ...
    model_overrides = {
        ...
        "TTAC_V7_TV_THRESHOLD": args.ttac_v7_tv_threshold,
        "TTAC_V7_TV_SLOPE": args.ttac_v7_tv_slope,
        "TTAC_V7_VALUE_MARGIN": args.ttac_v7_value_margin,
        "TTAC_V7_VALUE_TEMP": args.ttac_v7_value_temp,
        "TTAC_V7_CORRECTION_COEF": args.ttac_v7_correction_coef,
        "TTAC_V7_SUPPORT_COEF": args.ttac_v7_support_coef,
    }
