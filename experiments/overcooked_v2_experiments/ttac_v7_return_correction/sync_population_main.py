...
from overcooked_v2_experiments.ttac_v7_return_correction.sync_population_run import single_run
...
def main(config):
    ...
    if "NUM_ITERATIONS" in config:
        ...
        from overcooked_v2_experiments.ttac_v7_return_correction.sync_population_train import make_train
