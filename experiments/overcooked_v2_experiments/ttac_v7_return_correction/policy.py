...
from overcooked_v2_experiments.ttac_v7_return_correction.models.abstract import ActorCriticBase
from overcooked_v2_experiments.ttac_v7_return_correction.models.model import get_actor_critic, initialize_carry
from overcooked_v2_experiments.ttac_v7_return_correction.utils.surrogate_heads import (
    apply_q_eta,
    expected_joint_q,
)
from overcooked_v2_experiments.ttac_v7_return_correction.utils.agreement_heads import (
...
def policy_checkoints_to_functional_policy_pairing(
    ...
    return FunctionalPolicyPairing(
        tuple(policies),
        backend="ttac_v7_return_correction",
        config=config,
    )
