...
from overcooked_v2_experiments.ttac_v5_3_temporal_estimator.policy import PPOParams
from overcooked_v2_experiments.ttac_v5_3_temporal_estimator.utils.fcp import FCPWrapperPolicy
from overcooked_v2_experiments.ttac_v5_3_temporal_estimator.population_policy import FrozenCheckpointPopulationPolicy
...
def single_run(config):
    ...
    if "TTAC_V2_FROZEN_POPULATION" in config:
        ...
        print("Training TTACv2 with frozen checkpoint population", pop_cfg)
    ...
    with jax.disable_jit(False):
        ...
        elif frozen_population_policy is not None:
            print("Training with frozen checkpoint population")
            train_extra_args["population"] = frozen_population_policy
