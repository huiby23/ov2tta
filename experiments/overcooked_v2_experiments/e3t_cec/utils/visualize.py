...
from overcooked_v2_experiments.e3t_cec.policy import (
    E3TCECParams,
    policy_checkoints_to_policy_pairing,
)
from overcooked_v2_experiments.e3t_cec.utils.store import load_all_checkpoints
...
def visualize_e3t_cec_policy(
    ...
    if cross:
        ...
        for run_combination in run_combinations:
            ...
            cross_combinations[key_name] = PolicyPairing(
        ...
        all_params = jax.tree_util.tree_map(
            ...
            all_params,
            is_leaf=lambda x: type(x) is E3TCECParams,
        )
