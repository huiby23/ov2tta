...
from overcooked_v2_experiments.e3t_cec.policy import E3TCECParams
    ...
    for run_num_dir in run_dir.iterdir():
        ...
        for checkpoint_dir in run_num_dir.iterdir():
            ...
            config, params = load_checkpoint(
                run_dir,
                int(run_num_dir.name.split("_")[1]),
                ckpt_id,
            )
            checkpoints[checkpoint_dir.name] = E3TCECParams(params=params)
