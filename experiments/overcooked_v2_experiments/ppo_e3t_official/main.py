...
from overcooked_v2_experiments.ppo_e3t_official.policy import PPOParams
from overcooked_v2_experiments.ppo_e3t_official.utils.store import load_all_checkpoints, store_checkpoint
from overcooked_v2_experiments.ppo_e3t_official.utils.utils import get_run_base_dir
from overcooked_v2_experiments.ppo_e3t_official.utils.visualize_ppo import visualize_ppo_policy
...
def single_run_with_viz(config):
    from overcooked_v2_experiments.ppo_e3t_official.run import single_run
...
def main(config):
    ...
    if config["TUNE"]:
        from overcooked_v2_experiments.ppo_e3t_official.tune import tune

        tune(config)
    elif "NUM_ITERATIONS" in config:
        from overcooked_v2_experiments.ppo_e3t_official.state_sample_run import state_sample_run
