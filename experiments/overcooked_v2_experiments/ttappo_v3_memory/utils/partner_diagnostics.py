...
def diagnose_run(
    ...
    @jax.jit
    def _update_memory(params, hstate, aux, partner_action, done_batch):
        if mode == "memory_off":
            update_mask = jnp.zeros_like(done_batch, dtype=jnp.bool_)
        elif mode == "state_adapt":
        ...
        return next_hstate, update_mask.astype(jnp.float32)
    ...
    for run_key in run_keys:
        ...
        for _ in range(num_episodes):
            ...
            while not bool(jax.device_get(done["__all__"])):
                ...
                hstate, update_rate = _update_memory(
                    params,
                    next_hstate,
                    aux,
                    partner_action,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="state_adapt",
        choices=["memory_off", "state_adapt", "state_adapt_gated"],
    )
