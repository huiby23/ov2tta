...
from overcooked_v2_experiments.ttac_v5_4_loss_variants.sync_population_run import single_run
...
def main(config):
    ...
    if "NUM_ITERATIONS" in config:
        ...
        from overcooked_v2_experiments.ttac_v5_4_loss_variants.sync_population_train import make_train
