...
from overcooked_v2_experiments.ttac_v5_4_loss_variants.models.model import get_actor_critic, initialize_carry
from overcooked_v2_experiments.ttac_v5_4_loss_variants.utils.surrogate_heads import (
    apply_q_eta,
    expected_joint_q,
)
...
def policy_checkoints_to_functional_policy_pairing(
    ...
    return FunctionalPolicyPairing(
        tuple(policies),
        backend="ttac_v5_4_loss_variants",
        config=config,
    )
