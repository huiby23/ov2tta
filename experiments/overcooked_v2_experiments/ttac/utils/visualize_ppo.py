...
def visualize_ppo_policy(
    ...
    if eval_batches > 1:
        # Sequential mini-batches avoid materializing all SP/XP pairings in one
        # XLA program. This is especially important for TTAC online-adaptation
        # eval modes, whose policy state is larger than plain PPO.
