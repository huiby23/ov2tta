...
run_stage() {
  ...
  echo "[$(date +%F' '%T)] DONE ${name}" | tee -a "${LOG_DIR}/queue.log"
}
run_stage ttac_v2_relax_selfplay experiments/run_ttac_v2_pipeline_64_16.sh
